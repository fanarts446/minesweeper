class Design {
  ...
  draw() {
    (new Diagnosis()).print((new SingletonImageResource()).num9.isLoaded);
    // while(!(new SingletonImageResource()).num9.isLoaded) continue;
    ...
    (new Rectangle(this.ctx,
                   ...
                   300, 50,
                   baseRgb)).draw();
    (new Diagnosis()).print("draw");
    (new Diagnosis()).print((new SingletonImageResource()).num0);
    // w x h = 20 x 40
    this.ctx.drawImage((new SingletonImageResource()).num0,
                       55, 55);
    this.ctx.drawImage((new SingletonImageResource()).num1,
                       79, 55);
    this.ctx.drawImage((new SingletonImageResource()).num2,
                       103, 55);
    this.ctx.drawImage((new SingletonImageResource()).num3,
                       127, 55);
    this.ctx.drawImage((new SingletonImageResource()).num4,
                       151, 55);
    this.ctx.drawImage((new SingletonImageResource()).num5,
                       175, 55);
    this.ctx.drawImage((new SingletonImageResource()).num6,
                       199, 55);
    this.ctx.drawImage((new SingletonImageResource()).num7,
                       223, 55);
    this.ctx.drawImage((new SingletonImageResource()).num8,
                       247, 55);
    this.ctx.drawImage((new SingletonImageResource()).num9,
                       271, 55);
    this.ctx.drawImage((new SingletonImageResource()).colon,
                       295, 55);
    ...
    var a = new NumberPatterns(this.ctx,
                               new Point(195, 175),
                               9);
    // a.init();
    a.draw();

    // (new GameImage(this.ctx,
    //                new Point(55, 55),
    //                20, 40,
